...
OPTION(var_run_dir, OPT_STR, "/var/run/ceph")       // the "/var/run/ceph" dir, created on daemon startup
OPTION(admin_socket, OPT_STR, "$var_run_dir/$cluster-$name.asok") // default changed by common_preinit()
